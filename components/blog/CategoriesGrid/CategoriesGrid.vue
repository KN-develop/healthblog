        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="categories__post__item">
                    <div
                        ...
                        style="background-image: url('/img/categories/categories-post/cp-4.jpg')"
                    >
                        <div class="post__meta">
                            <h4>08</h4>
                            <span>Aug</span>
                ...
                <div
                    ...
                    style="background-image: url('/img/categories/categories-post/cp-6.jpg')"
                >
                    <div class="categories__post__item__text">
                        <div class="post__meta">
                            <h4>08</h4>
                ...
                <div class="categories__post__item">
                    <div
                        ...
                        style="background-image: url('/img/categories/categories-post/cp-8.jpg')"
                    >
                        <div class="post__meta">
                            <h4>08</h4>
                            <span>Aug</span>
                    ...
                    <div class="categories__post__item__text">
                        ...
                        <h3>
                            <a href="#">This 2-Ingredient Spread Makes Any Egg Sandwich So Much Better</a>
                        </h3>
                        <ul class="post__widget">
                            <li>by <span>Admin</span></li>
                            <li>3 min read</li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="categories__post__item">
                    <div
                        class="categories__post__item__pic smaller__large set-bg"
                        style="background-image: url('/img/categories/categories-post/cp-3.jpg')"
                    >
                        <div class="post__meta">
                            <h4>08</h4>
                            <span>Aug</span>
                ...
                <div class="categories__post__item__small">
                    ...
                    <p>
                        Lorem ipsum dolor amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt labore et
                        dolore magna aliqua gravida.
                    </p>
                ...
                <div class="categories__post__item">
                    <div
                        class="categories__post__item__pic smaller__large set-bg"
                        style="background-image: url('/img/categories/categories-post/cp-5.jpg')"
                    >
                        <div class="post__meta">
                            <h4>08</h4>
                            <span>Aug</span>
                ...
                <div class="categories__post__item">
                    <div
                        class="categories__post__item__pic set-bg"
                        style="background-image: url('/img/categories/categories-post/cp-7.jpg')"
                    >
                        <div class="post__meta">
                            <h4>08</h4>
                            <span>Aug</span>
        ...
        computedLists() {
            ...
            if (arr.length > 1) {
                for (let i = 1; i < arr.length - 1; i++) {
                    i % 2 ? res.left.push(arr[i]) : res.right.push(arr[i]);
                }
            }
